...
public class RabbitConfig {
    ...
    // Routing keys
    public static final String ROUTING_KEY_ALL = "#";                  // all events
    public static final String ROUTING_KEY_USERS = "user.*";           // user events
    public static final String ROUTING_KEY_MOVIES = "movie.*";         // movie events
    public static final String ROUTING_KEY_RATINGS = "rating.*";       // rating events
    public static final String ROUTING_KEY_SOCIAL = "social.*";        // social events
    public static final String ROUTING_KEY_ANALYTICS = "analytics.*";  // analytics events
    public static final String ROUTING_KEY_RECOMMENDATIONS = "recommend.*"; // recommendation events
    ...
    // JSON converter and RabbitTemplate
    @Bean
