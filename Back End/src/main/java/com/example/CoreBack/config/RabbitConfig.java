...
public class RabbitConfig {
    ...
    public static final String ROUTING_KEY_ANALYTICS = "analytics.*";  // eventos de analytics
    public static final String ROUTING_KEY_RECOMMENDATIONS = "recommend.*"; // eventos de recomendaciones
