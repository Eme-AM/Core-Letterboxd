...
public class AuthenticationController {
  ...
  public ResponseEntity<Object> requestInitialRegister(
    ...
    try {
      ...
      return ResponseEntity.ok("Registration request received for: " + request.getEmail());
    } catch (Exception e) {
  ...
  public ResponseEntity<String> resetPassword(
    ...
    throws ExistingUserException {
    try {
      authService.resetPassword(request.getEmail(), request.getVerificationCode(), request.getPassword());
